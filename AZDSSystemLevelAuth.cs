...
namespace AYKA.AZDSSystemLevelFunc
{
    public static class AZDSSystemLevelAuth
    {
        [FunctionName("AZDSSystemLevelAuth")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.System, "get", "post", Route = null)] HttpRequest req,
            ILogger log)
        {
            log.LogInformation("#################### SYSTEM LEVEL AUTHORIZATION FUNCTION #############################");
